package com.jqka.project.system.user.service.impl;

import com.jqka.common.exception.BusinessException;
import com.jqka.common.utils.StringUtils;
import com.jqka.common.utils.security.ShiroUtils;
import com.jqka.common.utils.text.Convert;
import com.jqka.project.system.user.dao.SysUserDao;
...
public class SysUserServiceImpl implements SysUserService {
     ...
     */
    @Override
    public String importUser(List<SysUserEntity> userList, Boolean isUpdateSupport) {
        ...
        for (SysUserEntity user : userList) {
            try {
                // 验证是否存在这个用户
                SysUserEntity u = userMapper.selectUserByLoginName(user.getLoginName());
    ...
    public int changeStatus(SysUserEntity user) {
        if (SysUserEntity.isAdmin(user.getUserId())) {
